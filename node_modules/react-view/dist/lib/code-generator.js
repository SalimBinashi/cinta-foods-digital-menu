...
exports.getCode = exports.formatCode = exports.formatAstAndPrint = exports.getAst = exports.getAstImports = exports.addToImportList = exports.getAstJsxElement = exports.getAstImport = exports.getAstReactHooks = exports.getAstPropsArray = exports.getAstPropValue = void 0;
/*
...
const getAstPropValue = (prop, name, customProps) => {
    ...
    switch (prop.type) {
        ...
        case const_1.PropTypes.Object:
            ...
            return template_1.default.ast(`a = ${value}`, { plugins: ['jsx'] })
                .expression.right;
...
exports.getAstPropValue = getAstPropValue;
const getAstPropsArray = (props, customProps) => {
...
exports.getAstPropsArray = getAstPropsArray;
const getAstReactHooks = (props, customProps) => {
    const hooks = [];
...
exports.getAstReactHooks = getAstReactHooks;
const getAstImport = (identifiers, source, defaultIdentifier) => {
...
exports.getAstImport = getAstImport;
const getAstJsxElement = (name, attrs, children) => {
...
exports.getAstJsxElement = getAstJsxElement;
...
exports.addToImportList = addToImportList;
const getAstImports = (importsConfig, providerImports, props) => {
    ...
    Object.values(props).forEach((prop) => {
        if (prop.imports &&
            ...
            exports.addToImportList(importList, prop.imports);
        }
    });
    exports.addToImportList(importList, providerImports);
    return Object.keys(importList).map((from) => exports.getAstImport(importList[from].named || [], from, importList[from].default));
};
exports.getAstImports = getAstImports;
const getChildrenAst = (value) => {
    return template_1.default.ast(`<>${value}</>`, {
        plugins: ['jsx'],
    }).expression.children;
};
const getAst = (props, componentName, provider, providerValue, importsConfig, customProps) => {
...
const formatAstAndPrint = (ast, printWidth) => {
...
exports.formatAstAndPrint = formatAstAndPrint;
const formatCode = (code) => {
    return exports.formatAstAndPrint(ast_1.parse(code));
};
exports.formatCode = formatCode;
const getCode = ({ props, componentName, provider, providerValue, importsConfig, customProps, }) => {
