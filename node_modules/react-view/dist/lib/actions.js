...
exports.reset = exports.updateProps = exports.updatePropsAndCode = exports.updatePropsAndCodeNoRecompile = exports.updateAll = exports.updateCodeAndProvider = exports.updateCode = void 0;
/*
...
const updateCode = (dispatch, newCode) => {
    dispatch({
...
const updateCodeAndProvider = (dispatch, newCode, providerValue) => {
    dispatch({
...
exports.updateCodeAndProvider = updateCodeAndProvider;
const updateAll = (dispatch, newCode, componentName, propsConfig, parseProvider, customProps) => {
    const propValues = {};
...
const updatePropsAndCodeNoRecompile = (dispatch, newCode, propName, propValue) => {
    dispatch({
...
exports.updatePropsAndCodeNoRecompile = updatePropsAndCodeNoRecompile;
const updatePropsAndCode = (dispatch, newCode, propName, propValue) => {
    dispatch({
...
exports.updatePropsAndCode = updatePropsAndCode;
const updateProps = (dispatch, propName, propValue) => {
    dispatch({
...
const reset = (dispatch, initialCode, providerValue, propsConfig) => {
    dispatch({
