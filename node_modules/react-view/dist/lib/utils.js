...
exports.getStyles = exports.clone = exports.useHover = exports.useValueDebounce = exports.buildPropsObj = exports.frameError = exports.formatBabelError = exports.assertUnreachable = void 0;
/*
...
exports.formatBabelError = formatBabelError;
const frameError = (error, code) => {
    if (error) {
...
const buildPropsObj = (stateProps, updatedPropValues) => {
    const newProps = {};
...
exports.buildPropsObj = buildPropsObj;
...
function useValueDebounce(globalVal, globalSet) {
...
exports.clone = clone;
function getStyles(style, className) {
