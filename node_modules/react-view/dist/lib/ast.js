...
exports.parseCode = exports.transformBeforeCompilation = exports.parse = void 0;
/*
...
const parse = (code) => parser_1.parse(code, {
    sourceType: 'module',
    plugins: [
        'jsx',
        'flowComments',
...
const transformBeforeCompilation = (ast, elementName, propsConfig) => {
    try {
...
exports.transformBeforeCompilation = transformBeforeCompilation;
