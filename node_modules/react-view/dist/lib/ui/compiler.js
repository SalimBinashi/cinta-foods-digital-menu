...
const Compiler = ({ scope, code, setError, transformations, placeholder, minHeight, presets, className, }) => {
    ...
    return (react_1.default.createElement("div", Object.assign({}, utils_1.getStyles({
        display: 'flex',
    ...
    }, className)), Element ? (react_1.default.createElement(Element, null)) : Placeholder ? (react_1.default.createElement(Placeholder, { height: minHeight || 32 })) : null));
};
