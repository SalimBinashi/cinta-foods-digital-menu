...
declare type TJsxChild = t.JSXText | t.JSXExpressionContainer | t.JSXSpreadChild | t.JSXElement | t.JSXFragment;
export declare const getAstPropValue: (prop: TProp, name: string, customProps: TCustomProps) => any;
...
export declare const getAstJsxElement: (name: string, attrs: (t.JSXAttribute | null)[], children: TJsxChild[]) => t.JSXElement;
...
export declare const getAst: (props: {
    [key: string]: TProp<any>;
}, componentName: string, provider: TProvider, providerValue: any, importsConfig: TImportsConfig, customProps: TCustomProps) => t.File;
